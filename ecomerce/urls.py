...
urlpatterns = [
   ...
   path('delete/<int:pk>/',views.deleteaddress, name="deleteaddress"),
   ...
   path('wishlist/', views.show_cart,name='showwishlist'),
   ...
   path("registation/", views.RegistationView.as_view(), name="registation"),
   path('accounts/login/', auth_view.LoginView.as_view(template_name='pages/login.html',authentication_form=LoginForm), name='login'), 
   path('passwordchange/', auth_view.PasswordChangeView.as_view(template_name='pages/passwordchange.html',form_class=MyPasswordChangeForm, success_url='/passwordchangedone'), name='passwordchange'),  
